    ...
    public partial class viewForm : Form
    {
        ...
        private void view_advisor_Click(object sender, EventArgs e)
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=E:\UniversityClubManagement\UniversityClubManagement\club.mdf;Integrated Security=True");
                ...
                con.Open();
                SqlDataAdapter sa = new SqlDataAdapter("select *from a where ClubName='"+comboBox1.Text+" ' ", con);
        ...
        private void view_committee_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                SqlDataAdapter sa = new SqlDataAdapter("select committee.Member_ID,committee.Student_ID,committee.club_name,IT.Name,committee.position,IT.dept,IT.batch,IT.phone,IT._address,IT.join_date from committee,IT where committee.Student_ID=IT.Student_ID", con);
                DataTable data1 = new DataTable();
                try
                {
                    sa.Fill(data1);
